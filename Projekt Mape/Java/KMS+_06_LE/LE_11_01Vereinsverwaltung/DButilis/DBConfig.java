...
public class DBConfig {
    ...
    private void loadConfig() {
        ...
        try (InputStream input = getClass().getClassLoader().getResourceAsStream("DButilis/DBconfig.properties")) {
            props.load(input);
            dbUrl = props.getProperty("db.url", "jdbc:mysql://localhost:3306/clupdb");
